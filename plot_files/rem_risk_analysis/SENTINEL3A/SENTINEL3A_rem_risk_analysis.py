...
df1 = pd.read_csv("SENTINEL3A_newSSN_2022.csv")
df2 = pd.read_csv("SENTINEL3A_oldSSN_pop_2022.csv")
df3 = pd.read_csv("SENTINEL3A_newSSN_pop_2022.csv")
...
fig.suptitle("SENTINEL-3A\nEpoch: 2022")
fig.tight_layout(pad = 3)
fig.savefig("SENTINEL3A_rem_risk_analysis.pdf", dpi = 3000, bbox_inches = "tight")
plt.show()