...
df = pd.read_csv("SENTINEL2A_oldSSN_2022.csv")
df1 = pd.read_csv("SENTINEL2A_newSSN_2022.csv")
df2 = pd.read_csv("SENTINEL2A_oldSSN_pop_2022.csv")
df3 = pd.read_csv("SENTINEL2A_newSSN_pop_2022.csv")
satellite_name = "SENTINEL2A"
ACPL = 0.0001
correction = -0.0023
...
fig.suptitle("SENTINEL-2A\nEpoch: 2022")
fig.tight_layout(pad = 3)
fig.savefig("SENTINEL2A_rem_risk_analysis.pdf", dpi = 3000, bbox_inches = "tight")
plt.show()