...
df = pd.read_csv("CHEOPS_oldSSN_2022.csv")
df1 = pd.read_csv("CHEOPS_newSSN_2022.csv")
df2 = pd.read_csv("CHEOPS_oldSSN_pop_2022.csv")
df3 = pd.read_csv("CHEOPS_newSSN_pop_2022.csv")
satellite_name = "CHEOPS"
ACPL = 0.00002
correction = -0.00024
correction_y = 0.006
...
fig.savefig("CHEOPS_rem_risk_analysis.pdf", dpi = 3000, bbox_inches = "tight")
plt.show()