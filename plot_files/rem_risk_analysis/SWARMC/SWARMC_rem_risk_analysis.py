...
df = pd.read_csv("SWARMC_oldSSN_2022.csv")
df1 = pd.read_csv("SWARMC_newSSN_2022.csv")
df2 = pd.read_csv("SWARMC_oldSSN_pop_2022.csv")
df3 = pd.read_csv("SWARMC_newSSN_pop_2022.csv")
satellite_name = "SWARM C"
ACPL = 0.0001
correction = -0.0009
...
#0.08
fig.suptitle("SWARM C\nEpoch: 2022")
fig.tight_layout(pad = 3)
fig.savefig("SWARMC_rem_risk_analysis.pdf", dpi = 3000, bbox_inches = "tight")
plt.show()