...
df = pd.read_csv("SENTINEL5P_oldSSN_2022.csv")
df1 = pd.read_csv("SENTINEL5P_newSSN_2022.csv")
df2 = pd.read_csv("SENTINEL5P_oldSSN_pop_2022.csv")
df3 = pd.read_csv("SENTINEL5P_newSSN_pop_2022.csv")
satellite_name = "SENTINEL5P"
ACPL = 5e-5
correction = -0.00023
...
fig.suptitle("SENTINEL-5P\nEpoch: 2022")
fig.tight_layout(pad = 3)
fig.savefig("SENTINEL5P_rem_risk_analysis.pdf", dpi = 3000, bbox_inches = "tight")
plt.show()