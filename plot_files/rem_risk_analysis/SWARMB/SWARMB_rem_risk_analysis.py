...
df = pd.read_csv("SWARMB_oldSSN_2022.csv")
df1 = pd.read_csv("SWARMB_newSSN_2022.csv")
df2 = pd.read_csv("SWARMB_oldSSN_pop_2022.csv")
df3 = pd.read_csv("SWARMB_newSSN_pop_2022.csv")
satellite_name = "SWARM B"
ACPL = 0.0001
correction = -0.0003
...
ax2.set_title("Old SSN with population size threshold > 2.26 cm")
...
ax3.set_title("New SSN with population size threshold > 2.26 cm")
...
#0.08
fig.suptitle("SWARM B\nEpoch: 2022")
fig.tight_layout(pad = 3)
fig.savefig("SWARMB_rem_risk_analysis.pdf", dpi = 3000, bbox_inches = "tight")
plt.show()