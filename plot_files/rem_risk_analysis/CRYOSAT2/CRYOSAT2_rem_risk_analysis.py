...
df = pd.read_csv("CRYOSAT2_oldSSN_2022.csv")
df1 = pd.read_csv("CRYOSAT2_newSSN_2022.csv")
df2 = pd.read_csv("CRYOSAT2_oldSSN_pop_2022.csv")
df3 = pd.read_csv("CRYOSAT2_newSSN_pop_2022.csv")
...
fig.suptitle("CRYOSAT-2\nEpoch: 2022")
fig.tight_layout(pad = 3)
fig.savefig("CRYOSAT2_rem_risk_analysis.pdf", dpi = 3000, bbox_inches = "tight")
plt.show()