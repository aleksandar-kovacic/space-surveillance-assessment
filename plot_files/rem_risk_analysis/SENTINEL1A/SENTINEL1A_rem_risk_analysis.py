...
df = pd.read_csv("SENTINEL1A_oldSSN_2022.csv")
df1 = pd.read_csv("SENTINEL1A_newSSN_2022.csv")
df2 = pd.read_csv("SENTINEL1A_oldSSN_pop_2022.csv")
df3 = pd.read_csv("SENTINEL1A_newSSN_pop_2022.csv")
satellite_name = "SENTINEL1A"
ACPL = 0.0001
correction = -0.012
...
#0.08
fig.suptitle("SENTINEL-1A\nEpoch: 2022")
fig.tight_layout(pad = 3)
fig.savefig("SENTINEL1A_rem_risk_analysis.pdf", dpi = 3000, bbox_inches = "tight")
plt.show()