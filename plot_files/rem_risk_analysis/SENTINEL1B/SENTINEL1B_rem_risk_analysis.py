...
df = pd.read_csv("SENTINEL1B_oldSSN_2022.csv")
df1 = pd.read_csv("SENTINEL1B_newSSN_2022.csv")
df2 = pd.read_csv("SENTINEL1B_oldSSN_pop_2022.csv")
df3 = pd.read_csv("SENTINEL1B_newSSN_pop_2022.csv")
satellite_name = "SENTINEL1B"
ACPL = 0.0001
correction = -0.0115
...
ax2.set_title("Old SSN with population size threshold > 2.84 cm")
...
ax3.set_title("New SSN with population size threshold > 2.84 cm")
...
fig.suptitle("SENTINEL-1B\nEpoch: 2022")
fig.tight_layout(pad = 3)
fig.savefig("SENTINEL1B_rem_risk_analysis.pdf", dpi = 3000, bbox_inches = "tight")
plt.show()