...
df = pd.read_csv("PROBA2_oldSSN_2022.csv")
df1 = pd.read_csv("PROBA2_newSSN_2022.csv")
df2 = pd.read_csv("PROBA2_oldSSN_pop_2022.csv")
df3 = pd.read_csv("PROBA2_newSSN_pop_2022.csv")
satellite_name = "PROBA2"
ACPL = 0.00003
correction = -0.00023
correction_y = 0.01
...
fig.suptitle("PROBA-2\nEpoch: 2022")
fig.tight_layout(pad = 3)
fig.savefig("PROBA2_rem_risk_analysis.pdf", dpi = 3000, bbox_inches = "tight")
plt.show()