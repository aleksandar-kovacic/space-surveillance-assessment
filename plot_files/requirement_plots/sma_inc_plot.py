...
ax.set_title("Manoeuvre rate of Sentinel-3A type mission with new SSN for the epoch 2036." + "\n" + " Spacecraft uncertainty set to 1 m and uncertainty table adjusted.")
#ax.set_title("Manoeuvre rate of Sentinel-3A type mission with" + "\n" + "new SSN for the epoch 2036 with catalogue uncertainty")
ax.set_ylabel("Inclination [°]")
ax.set_xlabel("Altitude [km]")
ax.invert_yaxis()
plt.savefig("cov_3_new.pdf" ,dpi = 1500, bbox_inches = "tight")
plt.show()